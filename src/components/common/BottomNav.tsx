  ...
  return (
    ...
    <Badge color="blue" count={wishlistData?.data?.products?.length}>
      <div className="flex flex-col items-center p-2 rounded-full  transition duration-300 cursor-pointer">
        ...
        <span className="text-xs text-gray-600 mt-1">Wishlist</span> {/* Text below the icon */}
      </div>
    </Badge>
    <Badge color="blue" count={wishlistData?.data?.products?.length}>
      <div className="flex flex-col items-center p-2 rounded-full  transition duration-300 cursor-pointer">
        ...
        <span className="text-xs text-gray-600 mt-1">Account</span> {/* Text below the icon */}
      </div>
    </Badge>
    ...
    <Badge color="blue" count={compareList?.length}>
      <div className="flex flex-col items-center p-2 rounded-full  transition duration-300 cursor-pointer">
        ...
        <span className="text-xs text-gray-600 mt-1">Compare</span> {/* Text below the icon */}
      </div>
    </Badge>
    ...
    <Badge color="blue" count={userCartData?.data?.products?.length}>
      <div className="flex flex-col items-center p-2 rounded-full  transition duration-300 cursor-pointer">
        ...
        <span className="text-xs text-gray-600 mt-1">Cart</span> {/* Text below the icon */}
      </div>
    </Badge>
